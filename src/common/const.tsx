...
export const profileSettings: IProfileSettingItem[] = [
  { icon: <GoLocation />, title: "Delivery address", url: browserRoutes.addresses },
  { icon: <BsBoxSeam />, title: "Order history", url: browserRoutes.orderHistory },
  { icon: <MdOutlineFavoriteBorder />, title: "Favorite", url: browserRoutes.favorites },
]
